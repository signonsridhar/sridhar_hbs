define([ 'can_fixture', 'Faker'], (can, Faker, State)->
    can.fixture('GET /bss/phonenumber?action=getavailablephonenumbers', (req, res)->
        return {
        "response": {
            "service": "getavailablephonenumbers",
            "response_code": 100,
            "execution_time": "312",
            ...
            "response_data": {
                "phone_numbers": [{
                    ...
                    "didid": "34faa1763c4e65429bb60bad7c508eff",
                    "phonenumber": "(444) 413-1444",
                    "area_code": "444",
                    "country_code": "US",
                    "city": "CUPERTINO",
                    "state": "NE",
